 ...
 * @docs-private
 */
declare function dispatchKeyboardEvent(node: Node, type: string, key?: string, modifiers?: ModifierKeys): KeyboardEvent;
/**
 ...
 * @docs-private
 */
declare function createKeyboardEvent(type: string, key?: string, modifiers?: ModifierKeys): KeyboardEvent;
/**
...
declare function mockPopoverAPI(): void;
